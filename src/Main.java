...
import static Packages.Util.GerenciadorDeClientes.*;
import static Packages.Util.GerenciadorDeFuncionarios.*;
import static Packages.Util.GerenciadorDeIngredientes.*;
import static Packages.Util.GerenciadorDeProdutos.*;
import static Packages.Util.GerenciadorDeCarrinho.*;
import static Packages.Util.RevisarOpcao.*;
import static Packages.Util.GerenciadorDeHistoricoPedido.*;
                        ...
                        do{
                            ...
                            if (simOuNao == 1) {
                                ...
                                if (simOuNao == 1) {
                                    ...
                                    listaPedidos = adicionarHistoricoPedido(historicoPedidos,listaDeCompras, id_LoginCliente, total);
