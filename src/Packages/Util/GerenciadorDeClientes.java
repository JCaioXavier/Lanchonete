...
import Packages.Entidades.Cliente;
import Packages.Entidades.Funcionario;
...
public class GerenciadorDeClientes {
    ...
    public static Cliente cadastrarCliente(List<Cliente> clientesExistentes) {//CADASTRAR NOVO CLIENTE ******************
        ...
        while (novoCliente.cpf.length() != 11) {
            System.out.println("CPF tem que ser igual a 11 caracteres.");
            System.out.print("Digite seu CPF: ");
            novoCliente.cpf = scanner.nextLine();
        }
        ...
        while (novoCliente.telefone.length() < 8 || novoCliente.nome.length() > 14) {
            System.out.println("Telefone tem que ser igual a 11 caracteres.");
            System.out.print("Digite seu telefone: ");
            novoCliente.telefone = scanner.nextLine();
        }
        ...
        do {
            ...
            if (novoCliente.endereco.isEmpty()) {
                System.out.println("Endereço não pode ser vazio ou apenas espaços! Digite novamente.");
            }
    ...
    public static void editarCliente(List<Cliente> clientes, int indexCliente) {
        ...
        do {
            ...
            while (clienteAtual.senha.length() > 50) {
                System.out.println("Senha não pode ser maior que 50 caracteres.");
                System.out.print("Digite a nova senha: ");
                clienteAtual.senha = scanner.nextLine();
            }
        ...
        while (clienteAtual.telefone.length() < 8 || clienteAtual.nome.length() > 14) {
